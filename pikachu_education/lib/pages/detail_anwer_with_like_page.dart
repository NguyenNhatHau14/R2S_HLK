...
class DetailAnswerWithLikePage extends StatefulWidget {
  const DetailAnswerWithLikePage({super.key});

  @override
  State<DetailAnswerWithLikePage> createState() =>
      _DetailAnswerWithLikePageState();
}

class _DetailAnswerWithLikePageState extends State<DetailAnswerWithLikePage> {
  @override
